# 🎓 سيناريو تدريبي - مرحباً بك في AuditOrbit!
## Training Scenario: Onboarding a New Team Member

---

## 👋 المقدمة

**المشهد:** أنت مهندس برمجيات جديد انضممت للفريق اليوم، وأنا (كمبرمج رئيسي بخبرة 10 سنوات) سأأخذك في جولة شاملة لفهم كل جزء من المنصة.

**الهدف:** بنهاية هذا التدريب، ستكون قادراً على:
1. فهم بنية المشروع بالكامل
2. التعامل مع كل endpoint في الـ API
3. ربط Backend مع Frontend
4. إضافة ميزة جديدة بنفسك

---

## 🚀 اليوم الأول - فهم المشروع

### الساعة 9:00 صباحاً - مقابلة الفريق

**أنا (المبرمج الرئيسي):** صباح الخير! مرحباً بك في فريق AuditOrbit. اسمي أحمد وسأكون مرشدك خلال الأسابيع القادمة.

**أنت (المبرمج الجديد):** شكراً! متحمس للبدء. ما هو AuditOrbit بالضبط؟

**أنا:** منصة تدقيق داخلي ذكية. تخيل أن لديك شركة كبيرة مثل أرامكو أو شركة طيران، وتحتاج لتدقيق كل العمليات: المالية، التشغيلية، IT Security، وغيرها. نحن نوفر منصة متكاملة لإدارة كل هذه العمليات بشكل منظم.

**أنت:** رائع! وما هي التقنيات المستخدمة؟

**أنا:** Backend عندنا FastAPI (Python)، Frontend Next.js (TypeScript)، Database PostgreSQL، وعندنا مختبر AI لتحليل النصوص.
