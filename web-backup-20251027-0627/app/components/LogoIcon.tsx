/**
 * AuditOrbit — Icon (inline SVG). Uses currentColor, inherits from parent.
 * لماذا: inline SVG يسمح بالتحكم في اللون عبر CSS/Theme بسهولة.
 */
export default function LogoIcon({ className }: { className?: string }) {
  return (
    <svg aria-label="AuditOrbit Icon" className={className} viewBox="0 0 256 256" role="img">
